<?
class icpc2t extends module{

    // Author: Herman Tolentino MD
    // CHITS Project 2004
    // ICPC2T table structures
    // ICPC is the International Classification for Primary Care by WONCA
    //
    ...
    function icpc2t() {
        ...
        $this->module = "icpc2t";
        $this->description = "CHITS Library - ICPC2T Codes";
    }
    ...
    function init_menu() {
        ...
        // menu entries
        module::set_menu($this->module, "ICPC2T Codes", "LIBRARIES", "_icpc2t");
    ...
    function init_sql() {
        ...
        module::execsql("CREATE TABLE m_lib_icpc2t ( ".
